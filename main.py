        ...
        try:
            for i in range(count-1, len(links)):
                ...
                if "acecwply" in url:
                    ...
                    url = f"https://cpatbots-updatee.com/extract_keys?url={url}@bots_updatee&user_id=5830856952"
                    ...
                    url = f"https://cpatbots-updatee.onrender.com/extract_keys?url={url}@bots_updatee&user_id=5830856952"
                    #url = f"https://drmapijion-botupdatevip.vercel.app/api?url={url}&token={raw_text4}"
                    #url = 'https://dragoapi.vercel.app/classplus?link=' + url
                    mpd, keys = helper.get_mps_and_keys(url)
                    url = mpd
                    ...
                    response = requests.get(f"https://cpatbots-updatee.onrender.com/extract_keys?url={url}@bots_updatee&user_id=5830856952")
